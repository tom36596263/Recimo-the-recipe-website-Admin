...
const loadReportData = async () => {
  try {
    ...
    // 實際應調用 API 獲取數據
    const response = await publicApi.get('data/social/gallery.json');
        ...
        <el-card class="detail-card" v-loading="loading">
          ...
          <div class="info-section">
            <el-row :gutter="20">
              <el-col :xs="24" :sm="12">
                <div class="info-item">
                  <span class="info-label">被檢舉圖片編號</span>
                  <div class="info-value">{{ reportData.image_id }}</div>
                </div>
              </el-col>
              <el-col :xs="24" :sm="12">
                <div class="info-item">
          ...
          <div class="info-section">
            <div class="info-item">
              ...
              <div class="image-preview">
                <img :src="reportData.image_url" :alt="reportData.image_alt" />
              </div>
            </div>
          </div>
