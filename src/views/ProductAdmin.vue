...
<template>
  <div>
    <!-- 內容區頂部 -->
      ...
      >
        <el-table-column prop="" label="商品編號" sortable="custom" align="center" width="180"/>
        <el-table-column prop="" label="商品類型" sortable="custom" align="center"/>
        <el-table-column prop="" label="商品名稱" align="center"/>
